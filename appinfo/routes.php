...
'routes' => [
		...
		/************************** PAYROLL ************************************/
		['name' => 'payroll#overview', 'url' => '/payroll', 'verb' => 'GET'],
		...
		['name' => 'payroll#updateRule', 'url' => '/payroll/rules/{ruleId}', 'verb' => 'PUT'],
		['name' => 'payroll#assignProfile', 'url' => '/payroll/plans/{planId}/profiles', 'verb' => 'POST'],
		['name' => 'payroll#updateProfileAssignment', 'url' => '/payroll/profile-assignments/{assignmentId}', 'verb' => 'PUT'],
		['name' => 'payroll#assignEmployeeRule', 'url' => '/payroll/employees/{employeeId}/rules', 'verb' => 'POST'],
		['name' => 'payroll#updateEmployeeRuleAssignment', 'url' => '/payroll/employee-rule-assignments/{assignmentId}', 'verb' => 'PUT'],
		['name' => 'payroll#addInput', 'url' => '/payroll/periods/{periodId}/inputs', 'verb' => 'POST'],
		['name' => 'payroll#updateInput', 'url' => '/payroll/inputs/{inputId}', 'verb' => 'PUT'],
		...
		/************************** UNIVERSAL AI IMPORT ************************************/
		['name' => 'ai_import#targets', 'url' => '/ai-import/targets', 'verb' => 'GET'],
		['name' => 'ai_import#create', 'url' => '/ai-import/{target}', 'verb' => 'POST'],
		['name' => 'ai_import#show', 'url' => '/ai-import/batches/{id}', 'verb' => 'GET'],
		['name' => 'ai_import#review', 'url' => '/ai-import/batches/{id}/review', 'verb' => 'POST'],
		['name' => 'ai_import#apply', 'url' => '/ai-import/batches/{id}/apply', 'verb' => 'POST'],
	],
];
