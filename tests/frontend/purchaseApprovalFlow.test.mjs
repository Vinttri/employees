...
const source = await readFile(new URL('../../src/utils/purchaseApprovalFlow.js', import.meta.url), 'utf8')
...
assert.equal(canApprovePurchaseFlow({ can_approve: false, current_approver: { authorizer_id: 'current' } }), false)
