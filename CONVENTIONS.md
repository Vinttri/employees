...
- Trabaja solo con files reales del repositorio.
- Nunca conviertas fragmentos pegados en files nuevos.
...
- Si el cambio requiere tocar otros files, indícalo antes de hacerlo.
