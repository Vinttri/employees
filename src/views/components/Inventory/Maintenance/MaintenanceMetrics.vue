...
export default {
	...
	computed: {
		items() {
			...
			return [
				{ key: 'scheduled', label: t('employees', 'Campaigns in visible range'), value: groups.length },
				{ key: 'pending', label: t('employees', 'Pending'), value: hasProgress ? totals.pending : '—' },
				{ key: 'in_progress', label: t('employees', 'In progress'), value: hasProgress ? totals.in_progress : '—' },
				{ key: 'completed', label: t('employees', 'Completed'), value: hasProgress ? totals.completed : '—' },
				{ key: 'overdue', label: t('employees', 'Overdue'), value: this.overdue },
			]
		},
	},
}
