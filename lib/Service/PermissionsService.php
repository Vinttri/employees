...
class PermissionsService {
	...
	/**
	 * Relación entre el name lógico del módulo y la configuración global.
	 *
	 * Si un módulo no está aquí, se considera habilitado por defecto.
	 * Esto permite tener permisos como "employees.hr" sin depender de un switch global.
	 */
	private const MODULE_CONFIG_KEYS = [
		'savings' => 'modulo_savings',
		'absences' => 'modulo_ausencias',
		'Client' => 'modulo_clients',
		'purchases' => 'modulo_purchases',
	...
	public function __construct(
		...
		private PermissionGroupMapper $permisoGrupoMapper,
	) {
	}
	...
	*/
	...
	| canSee('Client')
	| canSee('Client.admin')
	| canSee('purchases.approve')
	| requireCanSee('employees.admin')
	|
	*/
	...
	*/
	...
	private function getConfigMap(): array {
		...
		$config = $this->SettingsMapper->GetConfig();
		$map = [];
