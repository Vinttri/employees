...
class PermissionGroupsController extends Controller {
	...
	private const REQUIRED_PERMISSION_GROUPS = [
		[
			...
			'label' => 'Administradores de Client',
			'description' => 'Permite crear, editar, eliminar, importar y exportar Client.',
			'restricted' => true,
			'enabled' => true,
			'sort_order' => 300,
		],
		[
			'module' => 'Client',
			'permission' => 'view',
			'group_id' => 'clients_view',
			'label' => 'Consulta de Client',
			'description' => 'Permite consultar y ver Client sin administrar el catálogo.',
			'restricted' => false,
			'enabled' => true,
			'sort_order' => 310,
		],
